...
// sendRequestToAdminForProductQuantityIncrease
router.post("/sendRequestToAdmin", AdminController.productQuantityIncreaseRequest);
router.put("/unlockUserAccount", AdminController.UnlockUserAccount);
